...
export const migrateWorld = async function() {
  ...
  for ( let a of game.actors.entities ) {
    try {
      ...
      err.message = `Failed sw5efoundry system migration for Actor ${a.name}: ${err.message}`;
      console.error(err);
    }
  }
  ...
  for ( let i of game.items.entities ) {
    try {
      ...
      err.message = `Failed sw5efoundry system migration for Item ${i.name}: ${err.message}`;
      console.error(err);
    }
  }
  ...
  for ( let s of game.scenes.entities ) {
    try {
      ...
      err.message = `Failed sw5efoundry system migration for Scene ${s.name}: ${err.message}`;
      console.error(err);
    }
  }
...
export const migrateCompendium = async function(pack) {
  ...
  for ( let ent of content ) {
    ...
    // Handle migration failures
      ...
      err.message = `Failed sw5efoundry system migration for entity ${ent.name} in pack ${pack.collection}: ${err.message}`;
      console.error(err);
    }
  }
